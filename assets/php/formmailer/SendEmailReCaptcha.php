 ...
 * 
 * $Id: SendEmailReCaptcha.php 2022-04-25 15:36:02 +0200 Stefan S  1dd6ea859651c0939795e28aa38d460e23360ef4 $
 */
...
$publickey = isset(Configuration::$conf_siteKey) ? decrypt( Configuration::$conf_siteKey, $cryptKey) : "";
$privatekey = isset(Configuration::$conf_secretKey) ? decrypt( Configuration::$conf_secretKey, $cryptKey) : "";
...
if ( isset( $request["g-recaptcha-response"] ) || isset( $request["pending"] )) {
	...
	$error = ValidateLoadMainFormData( $formData, false );
